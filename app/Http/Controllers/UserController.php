...
class UserController extends Controller
{
    ...
    {    
        return view('users.form_user', ['roles' => Role::pluck('name', 'name')->all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('users')->with('success', 'Usuario generado con éxito');
    }
    ...
    public function edit($id)
    {
        ...
        return view('users.form_user', compact('user', 'roles', 'userRole'));
    }
